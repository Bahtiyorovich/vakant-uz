...
const Login = () => {
  ...
  return (
    <div className={`h-screen ${styles.flexCenter} bg-cyan-400`}>
        ...
        <div className="border-4 border-sky-400 h-full rounded-md">
          ...
          <form className={`h-[50%] flex items-start flex-col gap-4 px-10 py-4`}>
            <input 
              ...
              className="shadow-sm  w-full h-10 rounded-sm border border-gray-400 outline-cyan-400 px-4"/>
            <input 
              name="password" 
              type="password" 
            ...
            <button type="button" className="shadow-sm  bg-cyan-500 w-full h-10 rounded-sm text-white font-semibold">Login</button>
