  ...
  return (
    <div className="grid grid-cols-5 grid-rows-6 gap-4 h-[70vh]">
      ...
      >
        ...
        <h2 className="text-2xl font-semibold">Xush kelibsiz <span className="text-sky-500">Sherzodbek!</span></h2>
        ...
        <div className="flex items-center justify-start gap-4 mt-2">
          ...
          <p className="text-[14px]">Sherzodbek Yoqubov</p>
        </div>
        
        <div className="flex items-center justify-start gap-4 mt-2">
          <FaMapLocationDot className="text-sky-500 text-xl"/>
          <p className="text-[14px]">Namangan, Norin</p>
        </div>
        <div className="flex items-center justify-start gap-4 mt-2">
